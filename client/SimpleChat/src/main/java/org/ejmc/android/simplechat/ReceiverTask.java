...
public class ReceiverTask extends TimerTask {
    ...
    void doReceiverTask() throws IOException, JSONException {
        String resp = getResp();
    ...
    String getResp() throws JSONException, IOException {
    ...
    ServerResponse getServerResponse(String resp) throws JSONException {
        Gson gson = new Gson();
